...
> Inspired by [**"The Sound of Sorting"**](http://panthema.net/2013/sound-of-sorting/) by **Timo Bingmann** (panthema.net) — a C++/SDL program that visualizes and audibilizes sorting algorithms, famously featured in the viral YouTube video *"15 Sorting Algorithms in 6 Minutes."*
...
- **Timo Bingmann** ([panthema.net](http://panthema.net)) — Creator of [*"The Sound of Sorting"*](http://panthema.net/2013/sound-of-sorting/), the original inspiration for this project. His C++ program pioneered the concept of audibilizing sorting algorithms and was the first to demonstrate how musical tones can make algorithm behavior intuitive.

---

## 📄 License

This project is for educational purposes. The concept of audibilizing sorting algorithms was pioneered by Timo Bingmann's "The Sound of Sorting" (panthema.net).
